...
A live demo of the project is available at [https://bokeppascol.pages.dev](https://bokeppascol.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep pascol`)
...
1. Fork the [repository](https://github.com/kartatuka/bokeppascol/fork) on GitHub.
