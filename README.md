...
A live demo of the project is available at [https://bokeptetangga.pages.dev](https://bokeptetangga.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep tetangga`)
...
1. Fork the [repository](https://github.com/samjitu/bokeptetangga/fork) on GitHub.
