...
A live demo of the project is available at [https://bokepigo.pages.dev](https://bokepigo.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep igo`)
...
1. Fork the [repository](https://github.com/antotogek/bokepigo/fork) on GitHub.
