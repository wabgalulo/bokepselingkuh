...
A live demo of the project is available at [https://smpbugil.pages.dev](https://smpbugil.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `smp bugil`)
...
1. Fork the [repository](https://github.com/promsides/smpbugil/fork) on GitHub.
