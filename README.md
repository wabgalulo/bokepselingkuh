...
A live demo of the project is available at [https://togesd.pages.dev](https://togesd.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `toge sd`)
...
1. Fork the [repository](https://github.com/promsides/togesd/fork) on GitHub.
