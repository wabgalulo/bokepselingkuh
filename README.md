...
A live demo of the project is available at [https://bocil-viral.pages.dev](https://bocil-viral.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bocil viral`)
...
1. Fork the [repository](https://github.com/burutcale/bocil-viral/fork) on GitHub.
