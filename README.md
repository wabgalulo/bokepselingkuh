...
A live demo of the project is available at [https://bokeptante.pages.dev](https://bokeptante.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep tante`)
...
1. Fork the [repository](https://github.com/mejakursi527/bokeptante/fork) on GitHub.
