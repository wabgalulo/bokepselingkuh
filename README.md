...
A live demo of the project is available at [https://bokepsd.pages.dev](https://bokepsd.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep sd`)
...
1. Fork the [repository](https://github.com/opikartix/bokepsd/fork) on GitHub.
