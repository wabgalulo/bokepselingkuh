...
A live demo of the project is available at [https://bokephot.pages.dev](https://bokephot.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep hot`)
...
1. Fork the [repository](https://github.com/jassregi/bokephot/fork) on GitHub.
