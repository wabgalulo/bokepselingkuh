...
A live demo of the project is available at [https://bokeplive.pages.dev](https://bokeplive.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep live`)
...
1. Fork the [repository](https://github.com/lapelive/bokeplive/fork) on GitHub.
