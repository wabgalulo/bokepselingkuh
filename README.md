...
A live demo of the project is available at [https://bokepseragam.pages.dev](https://bokepseragam.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep seragam`)
...
1. Fork the [repository](https://github.com/teokaac/bokepseragam/fork) on GitHub.
