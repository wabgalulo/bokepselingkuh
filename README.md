...
A live demo of the project is available at [https://bokeplink.pages.dev](https://bokeplink.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep link`)
...
1. Fork the [repository](https://github.com/karpettriplek/bokeplink/fork) on GitHub.
