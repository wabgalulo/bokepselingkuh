...
A live demo of the project is available at [https://bokepkakak.pages.dev](https://bokepkakak.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep kakak`)
...
1. Fork the [repository](https://github.com/gundulcasan/bokepkakak/fork) on GitHub.
