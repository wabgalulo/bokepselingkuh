...
A live demo of the project is available at [https://bokeppijat.pages.dev](https://bokeppijat.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep pijat`)
...
1. Fork the [repository](https://github.com/jolk9110/bokeppijat/fork) on GitHub.
