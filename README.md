...
A live demo of the project is available at [https://bokepsma.pages.dev](https://bokepsma.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep sma`)
...
1. Fork the [repository](https://github.com/telejosice/bokepsma/fork) on GitHub.
