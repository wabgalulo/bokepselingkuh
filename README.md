...
A live demo of the project is available at [https://indojilbab.pages.dev](https://indojilbab.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `indo jilbab`)
...
1. Fork the [repository](https://github.com/samjitu/indojilbab/fork) on GitHub.
