...
A live demo of the project is available at [https://bocilcindo.pages.dev](https://bocilcindo.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bocil cindo`)
...
1. Fork the [repository](https://github.com/altoblesk/bocilcindo/fork) on GitHub.
