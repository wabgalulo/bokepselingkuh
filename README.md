...
A live demo of the project is available at [https://togesmp.pages.dev](https://togesmp.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `toge smp`)
...
1. Fork the [repository](https://github.com/saniporto/togesmp/fork) on GitHub.
