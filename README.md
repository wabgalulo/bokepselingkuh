...
A live demo of the project is available at [https://bocahviral.pages.dev](https://bocahviral.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bocah viral`)
...
1. Fork the [repository](https://github.com/promsides/bocahviral/fork) on GitHub.
