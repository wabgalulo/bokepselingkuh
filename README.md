...
A live demo of the project is available at [https://indotoge.pages.dev](https://indotoge.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `indo toge`)
...
1. Fork the [repository](https://github.com/samjitu/indotoge/fork) on GitHub.
