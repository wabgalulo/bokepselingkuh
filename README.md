...
A live demo of the project is available at [https://bokepsin.pages.dev](https://bokepsin.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokepsin`)
...
1. Fork the [repository](https://github.com/lapelive/bokepsin/fork) on GitHub.
