...
A live demo of the project is available at [https://toketbocil.pages.dev](https://toketbocil.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `toket bocil`)
...
1. Fork the [repository](https://github.com/samjitu/toketbocil/fork) on GitHub.
