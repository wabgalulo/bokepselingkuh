...
A live demo of the project is available at [https://bokeptocil.pages.dev](https://bokeptocil.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep tocil`)
...
1. Fork the [repository](https://github.com/puntirande/bokeptocil/fork) on GitHub.
