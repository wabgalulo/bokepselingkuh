...
A live demo of the project is available at [https://bokeppap.pages.dev](https://bokeppap.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep pap`)
...
1. Fork the [repository](https://github.com/atitigi/bokeppap/fork) on GitHub.
